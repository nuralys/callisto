...
class Service extends AppModel{
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/service/' . $fileName;
		$path_th = WWW_ROOT . 'img/service/thumbs/' . $fileName;
		if(!move_uploaded_file($file['img']['tmp_name'], $path)){
			return false;
		}
		$this->resizeImg($path, $path_th, 270, 171, $ext);
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/service/' . $name)){
