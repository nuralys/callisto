...
class PagesController extends AppController {
	...
	public $uses = array('Page', 'News', 'Slide');

	public function home(){
		$page = $this->Page->findById(11);
		...
		$title_for_layout = 'Косметологический центр в Астане - Callisto';
		$meta['keywords'] = 'keywords';
		$meta['description'] = 'description';
		$this->set(compact('title_for_layout', 'page', 'news', 'slides'));
	}
